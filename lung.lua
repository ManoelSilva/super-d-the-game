...
local function passSubLevel()
  ...
  elseif( playerDataTable.lungLifePoints <= lives ) then
    playerDataTable.lungPontuation = points
    playerDataTable.lungLifePoints = lives
    playerDataTable.lungUsedNucleums = generatedNucleums
  end
...
function scene:create( event )
  ...
  -- Load the background
  local background = display.newImageRect( backGroup, "assets/img/lung-background.png", display.actualContentWidth, display.actualContentHeight )
  ...
  -- Load nucleum
  nucleum = nucleumEntity:getNucleum( 490, 290 )
  backGroup:insert( nucleum )
  table.insert( nucleumTable, nucleum )
